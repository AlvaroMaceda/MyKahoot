...
function Layout({ children }: LayoutProps): JSX.Element {
  ...
  return (
    <div className='app-layout'>
      ...
      <footer>
        <small>© 2025 maceda &middot; <a href="https://github.com/AlvaroMaceda/MyKahoot" target="_blank" rel="noopener noreferrer" style={{marginLeft: '0.5em', textDecoration: 'none'}}>
          <svg height="20" width="20" viewBox="0 0 16 16" fill="currentColor" style={{verticalAlign: 'middle', marginRight: '0.2em'}} aria-hidden="true">
